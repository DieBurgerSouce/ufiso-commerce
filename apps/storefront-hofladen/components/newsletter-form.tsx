...
/**
 * Newsletter-Form Hofladen — identische Mechanik zu Tropfshop:
 * Honeypot + Validation + POST /api/newsletter -> Brevo DOI.
 * Brand-Text minimal angepasst ("Hofladen-Newsletter").
 */
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch("/api/newsletter", {
        ...
        body: JSON.stringify({ email, source: "pre-launch-hofladen", website }),
      });
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
      ...
      >
        ...
        />
        <span>
          Ich möchte den Hofladen-Newsletter erhalten und kann mich jederzeit
