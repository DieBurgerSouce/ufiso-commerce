...
/**
 * "Bald verfuegbar"-Tiles Hofladen — analog Tropfshop, aber gegen den
 * Sales Channel `hofladen` (durch den Publishable Key auf hofladen
 * gescoped, siehe ENV NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY).
 *
 * Phase 1: Tiles ohne Preise, keine Detail-Links — Coming-Soon-Vorschau.
 */
